 ...
 */
final class Version20190516210238 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employe_maintenance DROP FOREIGN KEY FK_2A066620B10ABAC9');
        $this->addSql('ALTER TABLE employe_maintenance ADD CONSTRAINT FK_2A066620B10ABAC9 FOREIGN KEY (id_Maintenance) REFERENCES maintenance (id) ON DELETE CASCADE');
    }
