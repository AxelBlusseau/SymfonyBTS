 ...
 */
final class Version20190516210421 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE maintenance ADD CONSTRAINT FK_2F84F8E994AE2FD9 FOREIGN KEY (id_Incident) REFERENCES incident (id) ON DELETE CASCADE');
    }
